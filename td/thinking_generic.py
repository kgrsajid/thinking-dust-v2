...
from .perception.nl_parser_generic import GenericNLParser, GenericEntityGraph
    ...
    def _compute_confidence(self, solution: dict | None, thoughts: list[Thought], sub_problems: list[dict]) -> float:
        ...
        if solution:
            ...
            if sol_type == "generic_csp":
                # Z3 SAT with primitives = high confidence
                return 0.90
            elif sol_type == "unsat":
                # Z3 proved unsatisfiable = very high confidence (it's a proof)
                return 0.95
